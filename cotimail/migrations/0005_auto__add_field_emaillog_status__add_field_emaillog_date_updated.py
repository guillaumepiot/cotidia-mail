...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailLog.status'
        db.add_column(u'cotimail_emaillog', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'EmailLog.date_updated'
        db.add_column(u'cotimail_emaillog', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default='2012-04-18 10:00', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailLog.status'
        db.delete_column(u'cotimail_emaillog', 'status')

        # Deleting field 'EmailLog.date_updated'
        db.delete_column(u'cotimail_emaillog', 'date_updated')
